...
public class MavenJDOMWriter {
    ...
    protected void updateActivation(Activation value, String xmlTag, Counter counter, Element element) {
        ...
        if (shouldExist) {
            ...
            findAndReplaceSimpleElement(
                    ...
                    root,
                    "activeByDefault",
                    (value.isActiveByDefault() == false) ? null : String.valueOf(value.isActiveByDefault()),
                    "false");
    ...
    protected void updateDeploymentRepository(
        ...
        if (shouldExist) {
            ...
            findAndReplaceSimpleElement(
                    ...
                    root,
                    "uniqueVersion",
                    (value.isUniqueVersion() == true) ? null : String.valueOf(value.isUniqueVersion()),
                    "true");
    ...
    protected void updateNotifier(Notifier value, String xmlTag, Counter counter, Element element) {
        ...
        findAndReplaceSimpleElement(
                ...
                root,
                "sendOnFailure",
                (value.isSendOnFailure() == true) ? null : String.valueOf(value.isSendOnFailure()),
                "true");
        findAndReplaceSimpleElement(
                innerCount,
                root,
                "sendOnSuccess",
                (value.isSendOnSuccess() == true) ? null : String.valueOf(value.isSendOnSuccess()),
                "true");
        findAndReplaceSimpleElement(
                innerCount,
                root,
                "sendOnWarning",
                (value.isSendOnWarning() == true) ? null : String.valueOf(value.isSendOnWarning()),
                "true");
    ...
    protected void updateReporting(Reporting value, String xmlTag, Counter counter, Element element) {
        ...
        if (shouldExist) {
            ...
            findAndReplaceSimpleElement(
                    ...
                    root,
                    "excludeDefaults",
                    (value.isExcludeDefaults() == false) ? null : String.valueOf(value.isExcludeDefaults()),
                    "false");
            findAndReplaceSimpleElement(innerCount, root, "outputDirectory", value.getOutputDirectory(), null);
