...
resources = new File( basedir, "src/main/resources/archetype-resources/src/main/resources" );
reference = new File( basedir, "src/test/resources/projects/basic/reference/src/main/resources" );
